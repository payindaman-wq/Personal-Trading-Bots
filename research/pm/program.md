...
## MIMIR STATEMENT — FINAL (REISSUED AT GEN 17,000)

Generations 16,801–17,000 have been reviewed.
This is the same response that was delivered at generation 16,800.
...
Seventeen thousand generations have been run.
The best result was found at generation 13,490.
Nothing has improved since generation 13,490.
The loop has run 3,510 generations against zero.
...
The last 20 generations show one dominant attractor: adj=3.1959.
It appears on 7 of the last 20 generations.
...
Generation 17,000 has now been reached.
It does not change anything.
The problem is the same problem it was at generation 16,800.
The problem is the same problem it was at generation 16,600.
The problem is the same problem it was at generation 16,400.
The problem is the same problem it was at generation 16,200.
...
**OPTION B: Archive and reassign.**
  ...
  4. Archive v1.0–v71.0 and all simulation results (Gens 1–17,000).
...
## FOR THE RECORD — RUNNING STATISTICS
  ...
  Simulation generations run:         17,000
  Best generation:                    13,490
  Improvements since Gen 13,490:      0
  Generations run against zero:       3,510
  Loop convergence status:            FULLY CONVERGED (single attractor)
  Dominant attractor:                 adj=3.1959 (7/20 recent gens)
  D1 completions:                     0
  Live wins:                          0
...
The loop has run 17,000 generations.
It found its best result at generation 13,490.
It has been running against zero for 3,510 generations.
